        ...
        socket.on("marketveri", function (t) {
            ...
            $.each(t.data, function (t, e) {
                ...
                if (new Date().getTime() - 864e5 < 1e3 * e.to_wallet_last_trade_date)
                    var a = e.change,
                r = $.fn.formattedNumber(e.to_wallet_24h_vol);
                else (a = "0.00"), (r = "0.00");
                ...
                $.fn.formattedNumber(e.to_wallet_last_price) +
    ...
    function myTradeHistory() {
        ...
        socket.on("mytradeData", function (t) {
            ...
            ($.each(t.data, function (t, e) {
                ...
                var r = $.fn.formattedNumber(e.trade_unit),
                l = $.fn.formattedNumber(e.trade_bid),
                o = ($.fn.formattedNumber(e.trade_total), e.trade_created),
                ...
                r +
                '</td><td class="text-right">' +
                $.fn.formattedNumber((e.trade_unit * e.trade_bid)) +
    ...
    $(document).ready(function () {
                ...
                if (t.data[0] || t.veri[0] != a) {
                    if (t.data[0] && t.veri[0] == a) {
                        ...
                        $.each(t.data, function (t, e) {
                            ...
                            o +
                            '">' +
                            $.fn.formattedNumber(e.exchange_bid) +
                            '</td><td class="text-right">' +
                            $.fn.formattedNumber(e.exchange_unit) +
                            '</td><td class="text-right">' +
                            $.fn.formattedNumber(e.exchange_total) +
        ...
        socket.on("marketveridetail", function (t) {
            if ("dolu" == t.i && t.veri[0] == n && t.veri[1] == h) {
                document.getElementById("pdec").value = t.data[0].market_priceDecimal;
                document.getElementById("adec").value = t.data[0].market_amountDecimal;
                document.getElementById("tdec").value = t.data[0].market_totalDecimal;
                console.log(decimals)
                var e = new Date().getTime() - 864e5,
                a = 1e3 * t.data[0].to_wallet_last_trade_date,
                r = $.fn.formattedNumber(t.data[0].to_wallet_last_price);
                if (e < a)
                    var l = t.data[0].change,
                o = $.fn.formattedNumber(t.data[0].to_wallet_24_high),
                i = $.fn.formattedNumber(t.data[0].to_walet_24_low),
                s = $.fn.formattedNumber(t.data[0].to_wallet_24h_vol);
                else (l = "0.00"), (o = "0.00"), (i = "0.00"), (s = "0.00");
                $("#lastPrice").html(r),
                $("#lastPriceUst").html(r),
                t.data[0].change < 0
            ...
            if ("bos" == t.i && t.veri[0] == n && t.veri[1] == h)
                for (i2 = 0; i2 < 16; i2++)
                    ...
                    $.each(t.data, function (t, e) {
                        ...
                        $("#sell-bids" + i).html(e._id.toFixed(document.getElementById("pdec").value)),
                        $("#sell-unit" + i).html(e.unit.toFixed(document.getElementById("adec").value)),
                        $("#sell-total" + i).html(a.toFixed(document.getElementById("tdec").value));
                    });
                }
            }),
            ...
            if ("bos" == t.i && t.veri[0] == n && t.veri[1] == h)
                for (i = 0; i < 16; i++)
                    ...
                    $.each(t.data, function (t, e) {
                        ...
                        $("#buy-bids" + s).html(e._id.toFixed(document.getElementById("pdec").value)),
                        $("#buy-unit" + s).html(e.unit.toFixed(document.getElementById("adec").value)),
                        $("#buy-total" + s).html(a.toFixed(document.getElementById("tdec").value));
                    });
                }
            }),
        ...
        socket.on("tradeData", function (t) {
            ...
            ($.each(t.data, function (t, e) {
                ...
                var r = e.trade_unit.toFixed(document.getElementById("adec").value),
                l = e.trade_bid.toFixed(document.getElementById("pdec").value),
                o = e.trade_created,
        ...
        if (0 != e && 0 != t) {
            ...
            socket.on("orderPageTradeData", function (t) {
                ...
                t.veri[1] == $("#hesap").html()
                    ...
                    var r = $.fn.formattedNumber(e.trade_unit),
                    l = $.fn.formattedNumber(e.trade_bid),
                    o = $.fn.formattedNumber(e.trade_total),
                    i = e.trade_created,
    ...
    function myFunction(t) {
        ...
        e.on("marketveri", function (t) {
            ...
            $.each(t.data, function (t, e) {
                if (new Date().getTime() - 864e5 < 1e3 * e.to_wallet_last_trade_date) {
                    var a = e.change,
                r = $.fn.formattedNumber(e.to_wallet_24_high),
                l = $.fn.formattedNumber(e.to_walet_24_low),
                o = $.fn.formattedNumber(e.to_wallet_24h_vol);
                }
                else (a = "0.00"), (r = "0.00"), (l = "0.00"), (o = "0.00");
